...
from auto_ui.ui_navire2 import Ui_Form as Navire_form
from auto_ui.ui_ajout_navire import Ui_Form as Ajout_navire_form
from auto_ui.ui_modifier_navire import Ui_Form as Modifier_navire_form

from classes.class_multiobjet import *
...
class NavireWindow(QWidget):
    def __init__(self):
        ...
        self.ui.valider_navire.clicked.connect(self.valider_navire)
    ...
    def valider_navire(self):
        selectedItems = self.ui.navire_table.selectedItems()
        print(self.ui.navire_table.item(self.ui.navire_table.currentRow().numerator,0).text())

        if len(selectedItems) == 2:
         self.rownavire = (self.ui.navire_table.verticalHeaderItem(selectedItems[0].row()).text(),self.ui.navire_table.item(self.ui.navire_table.currentRow().numerator,0).text())
        print(self.rownavire)
        self.close()
