...
################################################################################
## Form generated from reading UI file 'modifier_monnaienrKosQ.ui'
##
...
"")
        ...
        self.enregistrer_modifier_monnaie = QPushButton(self.frame_3)
        self.enregistrer_modifier_monnaie.setObjectName(u"enregistrer_modifier_monnaie")
        self.enregistrer_modifier_monnaie.setStyleSheet(u"QPushButton {width: 65px;\n"
"background-color: white;\n"
...
"")
        ...
        self.horizontalLayout_4.addWidget(self.enregistrer_modifier_monnaie)

        self.fermer_modifier_monnaie = QPushButton(self.frame_3)
        self.fermer_modifier_monnaie.setObjectName(u"fermer_modifier_monnaie")
        self.fermer_modifier_monnaie.setStyleSheet(u"QPushButton {background-color: white;\n"
...
"/*#ee2e31*/")
        ...
        self.horizontalLayout_4.addWidget(self.fermer_modifier_monnaie)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Modifier Monnaie", None))
        ...
        self.enregistrer_modifier_monnaie.setText(QCoreApplication.translate("Form", u"Enregistrer", None))
        self.fermer_modifier_monnaie.setText(QCoreApplication.translate("Form", u"Fermer", None))
    # retranslateUi
