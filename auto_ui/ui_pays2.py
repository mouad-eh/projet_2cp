...
################################################################################
## Form generated from reading UI file 'paysAZURRq.ui'
##
...
"border-radius: 10px;")
        ...
        self.pays_table.horizontalHeader().setStretchLastSection(True)
