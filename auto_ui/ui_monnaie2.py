...
################################################################################
## Form generated from reading UI file 'monnaiecRPEBl.ui'
##
...
"")
        ...
        self.valider_monnaie = QPushButton(self.frame_4)
        self.valider_monnaie.setObjectName(u"valider_monnaie")
        self.valider_monnaie.setStyleSheet(u"QPushButton {width: 65px;\n"
"background-color: white;\n"
...
"")
        ...
        self.verticalLayout_2.addWidget(self.valider_monnaie)
...
"border-radius: 10px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.valider_monnaie.setText(QCoreApplication.translate("Form", u"Valider", None))
