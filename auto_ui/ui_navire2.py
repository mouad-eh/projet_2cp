...
################################################################################
## Form generated from reading UI file 'navireyVExHg.ui'
##
...
"")
        ...
        self.valider_navire = QPushButton(self.groupBox_2)
        self.valider_navire.setObjectName(u"valider_navire")
        self.valider_navire.setMinimumSize(QSize(81, 30))
        self.valider_navire.setFont(font1)
        self.valider_navire.setStyleSheet(u"QPushButton {\n"
...
"QPushButton:pressed { margin: 1px; }")
        ...
        self.verticalLayout.addWidget(self.valider_navire)
...
"QPushButton:pressed{margin: 1px;}")
    ...
    def retranslateUi(self, Form):
        ...
        self.valider_navire.setText(QCoreApplication.translate("Form", u"valider", None))
