...
################################################################################
## Form generated from reading UI file 'monnaieFtrLYK.ui'
##
...
"")
        ...
        self.lineEdit_2.setStyleSheet(u"border : 1px solid #2f3e46;\n"
"border-radius:10px;\n"
"padding: 3px;\n"
"background-color: white;\n"
"color: #2f3e46;\n"
...
"/*#ee2e31*/")
        ...
        self.monnaie_table.setStyleSheet(u"background-color: rgba(255,255,255,0.9);\n"
...
"")
        ...
        self.monnaie_table.setAlternatingRowColors(False)
