...
from ui_pays import Ui_Form as Pays_form
from ui_ajout_pays import Ui_Form as Ajout_pays_form
from ui_modifier_pays import Ui_Form as Modifier_pays_form
...
class PaysWindow(QWidget):
    def __init__(self):
        ...
        # la recherche sera faite plus tard(
            # recherche par code_pays
            # recherche par libelle
        #)

        #self.ui.rechercher_pays.textChanged.connect(self.rechercher_pays)
    ...
    def rechercher_pays(self):
        sql = "SELECT * FROM pays WHERE nom LIKE '{}%'".format(self.ui.rechercher_pays.text())
